"""Snapshot Kalshi MLB market data to data/kalshi_mlb.json.
...
Mirrors scripts/fetch_kalshi_wnba.py.
"""
...
def fetch(series):
    url = f"{BASE}/markets?series_ticker={series}&status=open&limit=1000"
...
path = os.path.join(os.path.dirname(__file__), "..", "data", "kalshi_mlb.json")
